import{S as e}from"./Screen-CfcK4C-E.js";const u="prePassDeclaration",m=`#ifdef PREPASS
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[t]=a;const x={name:t,shader:a},N=Object.freeze(Object.defineProperty({__proto__:null,lightUboDeclarationWGSL:x},Symbol.toStringTag,{value:"Module"})),g="samplerFragmentDeclaration",X=`#ifdef _DEFINENAME_
...
#endif
`;e.IncludesShadersStoreWGSL[g]=X;const r="shadowsFragmentFunctions",o=`#ifdef SHADOWS
#ifndef SHADOWFLOAT
...
#endif
`;e.IncludesShadersStoreWGSL[r]=o;const D={name:r,shader:o},W=Object.freeze(Object.defineProperty({__proto__:null,shadowsFragmentFunctionsWGSL:D},Symbol.toStringTag,{value:"Module"})),i="bumpFragmentMainFunctions",f=`#if defined(BUMP) || defined(CLEARCOAT_BUMP) || defined(ANISOTROPIC) || defined(DETAIL)
...
#endif
`;e.IncludesShadersStoreWGSL[i]=f;const T={name:i,shader:f},R=Object.freeze(Object.defineProperty({__proto__:null,bumpFragmentMainFunctionsWGSL:T},Symbol.toStringTag,{value:"Module"})),s="bumpFragmentFunctions",n=`#if defined(BUMP)
...
#endif
`;e.IncludesShadersStoreWGSL[s]=n;const L={name:s,shader:n},U=Object.freeze(Object.defineProperty({__proto__:null,bumpFragmentFunctionsWGSL:L},Symbol.toStringTag,{value:"Module"})),d="reflectionFunction",l=`fn computeFixedEquirectangularCoords(worldPos: vec4f,worldNormal: vec3f,direction: vec3f)->vec3f
...
#endif
`;e.IncludesShadersStoreWGSL[d]=l;const I={name:d,shader:l},H=Object.freeze(Object.defineProperty({__proto__:null,reflectionFunctionWGSL:I},Symbol.toStringTag,{value:"Module"})),C="decalFragment",y=`#ifdef DECAL
...
#endif
`;e.IncludesShadersStoreWGSL[C]=y;const h="bumpFragment",p=`var uvOffset: vec2f= vec2f(0.0,0.0);
...
#endif
`;e.IncludesShadersStoreWGSL[h]=p;const P={name:h,shader:p},k=Object.freeze(Object.defineProperty({__proto__:null,bumpFragmentWGSL:P},Symbol.toStringTag,{value:"Module"})),M="depthPrePass",A=`#ifdef DEPTHPREPASS
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[v]=c;const E={name:v,shader:c},V=Object.freeze(Object.defineProperty({__proto__:null,lightFragmentWGSL:E},Symbol.toStringTag,{value:"Module"})),_="logDepthFragment",F=`#ifdef LOGARITHMICDEPTH
fragmentOutputs.fragDepth=log2(fragmentInputs.vFragmentDepth)*uniforms.logarithmicDepthConstant*0.5;
#endif
`;e.IncludesShadersStoreWGSL[_]=F;const b="oitFragment",O=`#ifdef ORDER_INDEPENDENT_TRANSPARENCY
...
#endif
`;e.IncludesShadersStoreWGSL[b]=O;export{T as a,L as b,P as c,x as d,N as e,W as f,R as g,U as h,H as i,k as j,V as k,E as l,I as r,D as s};
